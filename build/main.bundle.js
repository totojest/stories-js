...
var Toast = exports.Toast = function () {
    ...
    _createClass(Toast, [{
        ...
        value: function toastIt() {
            ...
            toaster.addClass('toast').addClass(this.backgroundClass).addClass('animated').addClass('fadeInDownBig').html('<p>' + this.message + '</p>');
            ...
            setTimeout(function () {
                ...
                toaster.remove().addClass('fadeOutRightBig');
            }, this.duration * 1000);
        }
    }]);
